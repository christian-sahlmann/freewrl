========================================================================
    ACTIVEX CONTROL DLL : freeWRLAx Project Overview
========================================================================

ControlWizard has created this project for your freeWRLAx ActiveX Control
...
that make up your freeWRLAx ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CfreeWRLCtrl control:

freeWRLCtrl.h
    This file contains the declaration of the CfreeWRLCtrl C++ class.

freeWRLCtrl.cpp
    This file contains the implementation of the CfreeWRLCtrl C++ class.

freeWRLPpg.h
    This file contains the declaration of the CfreeWRLPropPage C++ class.

freeWRLPpg.cpp
    This file contains the implementation of the CfreeWRLPropPage C++ class.

CfreeWRLCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CfreeWRLCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file freeWRLAx.rc.
...
stdafx.h, stdafx.cpp
    ...
    named freeWRLAx.pch and a precompiled types (PCT) file named stdafx.obj.
